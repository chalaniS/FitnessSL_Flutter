...
class _EventListViewState extends State<EventListView> {
  ...
  void deleteEvent(String key) {
    ...
    databaseReference.child(key).remove().then((_) {
      ...
      setState(() {
        eventsData.removeWhere((event) => event['key'] == key);
      });
    });
              ...
              children: <Widget>[
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final eventKey = event.keys; // Key of the event

                    return Container(
                      padding: const EdgeInsets.all(8),
                      child: Card(
                        color: const Color.fromARGB(255, 173, 209,
                            238), // Set the background color here
                        elevation: 2,
                        child: Container(
